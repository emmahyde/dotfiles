The following outlines **some of the most commonly used helpers** available in Action View. It serves as a good starting point, but reviewing the full [API Documentation](https://api.rubyonrails.org/v8.1.3/classes/ActionView/Helpers.html) is also recommended, as it covers all of the helpers in more detail.
...
See the [`distance_of_time_in_words` API Documentation](https://api.rubyonrails.org/v8.1.3/classes/ActionView/Helpers/DateHelper.html#method-i-distance_of_time_in_words) for more information.
...
```
Copy
See the [`time_ago_in_words` API Documentation](https://api.rubyonrails.org/v8.1.3/classes/ActionView/Helpers/DateHelper.html#method-i-time_ago_in_words) for more information.
...
```
Copy
See the [`number_to_currency` API Documentation](https://api.rubyonrails.org/v8.1.3/classes/ActionView/Helpers/NumberHelper.html#method-i-number_to_currency) for more information.
...
```
Copy
See the [`number_to_human` API Documentation](https://api.rubyonrails.org/v8.1.3/classes/ActionView/Helpers/NumberHelper.html#method-i-number_to_human) for more information.
...
```
Copy
See the [`number_to_human_size` API Documentation](https://api.rubyonrails.org/v8.1.3/classes/ActionView/Helpers/NumberHelper.html#method-i-number_to_human_size) for more information.
...
```
Copy
See the [`number_to_percentage` API Documentation](https://api.rubyonrails.org/v8.1.3/classes/ActionView/Helpers/NumberHelper.html#method-i-number_to_percentage) for more information.
...
```
Copy
See the [`number_to_phone` API Documentation](https://api.rubyonrails.org/v8.1.3/classes/ActionView/Helpers/NumberHelper.html#method-i-number_to_phone) for more information.
...
```
Copy
See the [`number_with_delimiter` API Documentation](https://api.rubyonrails.org/v8.1.3/classes/ActionView/Helpers/NumberHelper.html#method-i-number_with_delimiter) for more information.
...
```
Copy
See the [`number_with_precision` API Documentation](https://api.rubyonrails.org/v8.1.3/classes/ActionView/Helpers/NumberHelper.html#method-i-number_with_precision) for more information.
...
```
Copy
See the [`excerpt` API Documentation](https://api.rubyonrails.org/v8.1.3/classes/ActionView/Helpers/TextHelper.html#method-i-excerpt) for more information.
...
```
Copy
See the [`pluralize` API Documentation](https://api.rubyonrails.org/v8.1.3/classes/ActionView/Helpers/TextHelper.html#method-i-pluralize) for more information.
...
```
Copy
See the [`truncate` API Documentation](https://api.rubyonrails.org/v8.1.3/classes/ActionView/Helpers/TextHelper.html#method-i-truncate) for more information.
...
```
Copy
See the [`word_wrap` API Documentation](https://api.rubyonrails.org/v8.1.3/classes/ActionView/Helpers/TextHelper.html#method-i-word_wrap) for more information.
...
You can learn more about form helpers in the [Action View Form Helpers Guide](https://guides.rubyonrails.org/form_helpers.html).
...
```
Copy
See the [`button_to` API Documentation](https://api.rubyonrails.org/v8.1.3/classes/ActionView/Helpers/UrlHelper.html#method-i-button_to) for more information.
...
```
Copy
See the [`current_page?` API Documentation](https://api.rubyonrails.org/v8.1.3/classes/ActionView/Helpers/UrlHelper.html#method-i-current_page-3F) for more information.
...
```
Copy
See the [`link_to` API Documentation](https://api.rubyonrails.org/v8.1.3/classes/ActionView/Helpers/UrlHelper.html#method-i-link_to) for more information.
...
```
Copy
See the [`mail_to` API Documentation](https://api.rubyonrails.org/v8.1.3/classes/ActionView/Helpers/UrlHelper.html#method-i-mail_to) for more information.
...
This functionality is powered internally by the [rails-html-sanitizer](https://github.com/rails/rails-html-sanitizer) gem.
...
```
Copy
See the [`sanitize` API Documentation](https://api.rubyonrails.org/v8.1.3/classes/ActionView/Helpers/SanitizeHelper.html#method-i-sanitize) for more information.
...
```
Copy
See the [`sanitize_css` API Documentation](https://api.rubyonrails.org/v8.1.3/classes/ActionView/Helpers/SanitizeHelper.html#method-i-sanitize_css) for more information.
...
```
Copy
See the [`strip_links` API Documentation](https://api.rubyonrails.org/v8.1.3/classes/ActionView/Helpers/SanitizeHelper.html#method-i-strip_links) for more information.
...
```
Copy
See the [`strip_tags` API Documentation](https://api.rubyonrails.org/v8.1.3/classes/ActionView/Helpers/SanitizeHelper.html#method-i-strip_tags) for more information.

## 5. Assets
A set of methods for generating HTML that links views to assets such as images, JavaScript files, stylesheets, and feeds.
By default, Rails links to these assets on the current host in the public folder, but you can direct Rails to link to assets from a dedicated assets server by setting [`config.asset_host`](https://guides.rubyonrails.org/configuring.html#config-asset-host) in the application configuration, typically in `config/environments/production.rb`.
...
### 5.1. audio_tag
Generates an HTML audio tag with source(s), either as a single tag for a string source or nested source tags within an array for multiple sources. The `sources` can be full paths, files in your public audios directory, or [Active Storage attachments](https://guides.rubyonrails.org/active_storage_overview.html).
...
```
Copy
Internally, `audio_tag` uses [`audio_path` from the AssetUrlHelpers](https://api.rubyonrails.org/v8.1.3/classes/ActionView/Helpers/AssetUrlHelper.html#method-i-audio_path) to build the audio path.
See the [`audio_tag` API Documentation](https://api.rubyonrails.org/v8.1.3/classes/ActionView/Helpers/AssetTagHelper.html#method-i-audio_tag) for more information.
...
```
Copy
See the [`auto_discovery_link_tag` API Documentation](https://api.rubyonrails.org/v8.1.3/classes/ActionView/Helpers/AssetTagHelper.html#method-i-auto_discovery_link_tag) for more information.
...
```
Copy
See the [`favicon_link_tag` API Documentation](https://api.rubyonrails.org/v8.1.3/classes/ActionView/Helpers/AssetTagHelper.html#method-i-favicon_link_tag) for more information.
...
```
Copy
Internally, `image_tag` uses [`image_path` from the AssetUrlHelpers](https://api.rubyonrails.org/v8.1.3/classes/ActionView/Helpers/AssetUrlHelper.html#method-i-image_path) to build the image path.
See the [`image_tag` API Documentation](https://api.rubyonrails.org/v8.1.3/classes/ActionView/Helpers/AssetTagHelper.html#method-i-image_tag) for more information.
...
Internally, `javascript_include_tag` uses [`javascript_path` from the AssetUrlHelpers](https://api.rubyonrails.org/v8.1.3/classes/ActionView/Helpers/AssetUrlHelper.html#method-i-javascript_path) to build the script path.
See the [`javascript_include_tag` API Documentation](https://api.rubyonrails.org/v8.1.3/classes/ActionView/Helpers/AssetTagHelper.html#method-i-javascript_include_tag) for more information.
...
```
Copy
See the [`picture_tag` API Documentation](https://api.rubyonrails.org/v8.1.3/classes/ActionView/Helpers/AssetTagHelper.html#method-i-picture_tag) for more information.
...
```
Copy
See the [`preload_link_tag` API Documentation](https://api.rubyonrails.org/v8.1.3/classes/ActionView/Helpers/AssetTagHelper.html#method-i-preload_link_tag) for more information.
...
Internally, `stylesheet_link_tag` uses [`stylesheet_path` from the AssetUrlHelpers](https://api.rubyonrails.org/v8.1.3/classes/ActionView/Helpers/AssetUrlHelper.html#method-i-stylesheet_path) to build the stylesheet path.
See the [`stylesheet_link_tag` API Documentation](https://api.rubyonrails.org/v8.1.3/classes/ActionView/Helpers/AssetTagHelper.html#method-i-stylesheet_link_tag) for more information.
...
```
Copy
Internally, `video_tag` uses [`video_path` from the AssetUrlHelpers](https://api.rubyonrails.org/v8.1.3/classes/ActionView/Helpers/AssetUrlHelper.html#method-i-video_path) to build the video path.
See the [`video_tag` API Documentation](https://api.rubyonrails.org/v8.1.3/classes/ActionView/Helpers/AssetTagHelper.html#method-i-video_tag) for more information.
...
See the [`escape_javascript` API Documentation](https://api.rubyonrails.org/v8.1.3/classes/ActionView/Helpers/JavaScriptHelper.html#method-i-escape_javascript) for more information.
...
```
Copy
See the [`javascript_tag` API Documentation](https://api.rubyonrails.org/v8.1.3/classes/ActionView/Helpers/JavaScriptHelper.html#method-i-javascript_tag) for more information.
...
```
Copy
See the [`tag` API Documentation](https://api.rubyonrails.org/v8.1.3/classes/ActionView/Helpers/TagHelper.html#method-i-tag) for more information.
...
```
Copy
See the [`capture` API Documentation](https://api.rubyonrails.org/v8.1.3/classes/ActionView/Helpers/CaptureHelper.html#method-i-capture) for more information.
...
You may be thinking what's the difference between `capture` and `content_for`? `capture` is used to capture a block of markup in a variable, while `content_for` is used to store a block of markup in an identifier for later use. Internally `content_for` actually calls `capture`. However, the key difference lies in their behavior when invoked multiple times. `content_for` can be called repeatedly, concatenating the blocks it receives for a specific identifier in the order they are provided. Each subsequent call simply adds to what's already stored. In contrast, `capture` only returns the content of the block, without keeping track of any previous invocations.
See the [`content_for` API Documentation](https://api.rubyonrails.org/v8.1.3/classes/ActionView/Helpers/CaptureHelper.html#method-i-content_for) for more information.
...
See the [`benchmark` API Documentation](https://api.rubyonrails.org/v8.1.3/classes/ActiveSupport/Benchmarkable.html#method-i-benchmark) for more information.
...
```
Copy
See [`Fragment Caching`](https://guides.rubyonrails.org/caching_with_rails.html#fragment-caching) and the [`cache` API Documentation](https://api.rubyonrails.org/v8.1.3/classes/ActionView/Helpers/CacheHelper.html#method-i-cache) for more information.
...
```
Copy
See the [`atom_feed` API Documentation](https://api.rubyonrails.org/v8.1.3/classes/ActionView/Helpers/AtomFeedHelper.html#method-i-atom_feed) for more information.
...
```
Copy
See the [`debug` API Documentation](https://api.rubyonrails.org/v8.1.3/classes/ActionView/Helpers/DebugHelper.html#method-i-debug) for more information.
The following outlines **some of the most commonly used helpers** available in Action View. It serves as a good starting point, but reviewing the full [API Documentation](https://api.rubyonrails.org/v8.1.3/classes/ActionView/Helpers.html) is also recommended, as it covers all of the helpers in more detail.
