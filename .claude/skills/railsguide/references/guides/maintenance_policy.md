...
## 2. New Features
New features are only added to the main branch and will not be made available in Patch releases.
...
## 7. npm Packages
Due to a constraint with npm, we are unable to use the 4th digit for security releases of [npm packages](https://www.npmjs.com/org/rails) provided by Rails. This means that instead of the equivalent gem version `7.0.1.4`, the npm package will be versioned `7.0.104`.
